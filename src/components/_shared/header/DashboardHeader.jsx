        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-1 items-start justify-between">
            <div className="space-y-1">
              ...
              <h1 className="font-bold lg:text-2xl md:text-xl text-lg text-white">TES</h1>
              {/* {user && (
                ...
                <div className="flex items-center md:gap-3 gap-1">
                  <h3 className="md:text-base text-sm font-semibold text-white">👋 Halo, TES!</h3>
                    <CustomBadge type="info" rounded="full" weight="semibold" className="md:block hidden">
                      {/* <p className="capitalize">{role.toLowerCase()}</p> */}
                      <p className="capitalize">TES</p>
                    </CustomBadge>
                </div>
            </div>
          </div>
